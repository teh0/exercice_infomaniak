...
<div data-page="book-edit" class="app-container">
    ...
    <form enctype="multipart/form-data" action="{{ route('updateBook', $book->id )}}" method="POST" class="form-borrowell">
        ...
        <div class="block-form">
            ...
            <input id="book_title" type="text" value="{{ $book->title }}" placeholder="Titre" class=" @error('book_title') invalid @enderror" name="book_title" value="{{ old('book_title') }}" required autofocus>
        </div>
        ...
        <div class="block-form">
            ...
            <input id="book_author" type="text" value="{{ $book->authors }}" placeholder="Auteur" class=" @error('book_author') invalid @enderror" name="book_author" value="{{ old('book_author') }}" required>
        </div>
        ...
        <div class="block-form">
            ...
            <textarea id="book_description" placeholder="Description" class=" @error('book_description') invalid @enderror" name="book_description" value="{{ old('book_description') }}" required>
        ...
        <div class="block-form">
            ...
            <input type="text" value="{{ $book->pageCount }}" id="book_pageCount" placeholder="Nombre de page" class=" @error('book_pageCount') invalid @enderror" name="book_pageCount" value="{{ old('book_pageCount') }}" required>
        </div>
        ...
        <div class="block-form">
            ...
            <input type="text" value="{{ $book->lang }}" id="book_lang" placeholder="Langue" class=" @error('book_lang') invalid @enderror" name="book_lang" value="{{ old('book_lang') }}" required>
        </div>
