...
- La platforme de réservation de livres.
...
### 1. La plateforme de réservation de livres
  ...
  Cette partie représente 80% du travail. C'est le corp de la plateforme qui permettra aux utilisateurs d'accéder aux différents services en fonction de leur statut :
...
| - Ne peut pas emprunter un livre.              | - Consultation de la fiche technique du livre (version plus détaillée) | - Accès à un back-office pour la gestion des utilisateur et des livres (actions [CRUD](https://en.wikipedia.org/wiki/Create,_read,_update_and_delete)). |
